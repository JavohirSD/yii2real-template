...
class Generator extends \yii\gii\Generator
{
    ...
    public function generateRules($table)
    {
        ...
        if($image == 1) {
            $rules[] = "['crop_image', 'string', 'max' => 255]";
            $rules[] = "[['image'], 'file',  'extensions' => ['png', 'jpg','jpeg','bmp','svg'], 'checkExtensionByMimeType'=>true,'maxSize'=>1024*1024*8]";
        }
